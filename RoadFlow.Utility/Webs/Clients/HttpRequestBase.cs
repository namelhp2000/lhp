...
namespace RoadFlow.Utility.Webs.Clients
{
    ...
    public abstract class HttpRequestBase<TRequest> where TRequest : IRequest<TRequest>
    {
        ...
        /// Http动词
        /// </summary>
        private readonly System.Net.Http.HttpMethod _httpMethod;
        /// <summary>
        /// 参数集合
        /// </summary>
        ...
        protected HttpRequestBase(System.Net.Http.HttpMethod httpMethod, string url)
        {
