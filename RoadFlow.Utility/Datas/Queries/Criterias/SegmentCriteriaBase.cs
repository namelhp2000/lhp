...
namespace RoadFlow.Utility.Datas.Queries.Criterias
{
    /// <summary>
    /// 范围过滤条件
    /// </summary>
        ...
        where TValue : struct
    {
        ...
        {
            return LambdaHelper.GetType(_propertyExpression);
        }
        ...
        {
            return LambdaHelper.Constant(_min, _propertyExpression);
        }
        ...
        {
            return LambdaHelper.Constant(_max, _propertyExpression);
        }
    }
}
