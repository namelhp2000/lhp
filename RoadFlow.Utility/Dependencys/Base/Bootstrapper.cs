...
using RoadFlow.Utility.Events.Handlers;
using RoadFlow.Utility.Reflections;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Reflection;

namespace RoadFlow.Utility.Dependencys
{
    /// <summary>
    /// 依赖引导器
    /// </summary>
    public class Bootstrapper
    {
        ...
        public IServiceProvider Bootstrap()
        {
            ...
            return IocHelper.DefaultContainer.Register(_services, RegisterServices, _configs);
        }
        ...
        private void ResolveDependencyRegistrar()
        {
            ...
            types.Select(type => ReflectionHelper.CreateInstance<IDependencyRegistrar>(type)).ToList().ForEach(t => t.Register(_services));
        }
    }
}
