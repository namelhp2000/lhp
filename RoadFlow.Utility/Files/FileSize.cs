namespace RoadFlow.Utility.Files
{
    ...
    public struct FileSize
    {
        ...
        {
            return ConvertHelper.ToDouble(_size / 1024.0, 2);
        }
        ...
        {
            return ConvertHelper.ToDouble(_size / 1024.0 / 1024.0, 2);
        }
        ...
        {
            return ConvertHelper.ToDouble(_size / 1024.0 / 1024.0 / 1024.0, 2);
        }
