...
namespace RoadFlow.Utility.Files.Paths
{
    /// <summary>
    /// 路径生成器
    /// </summary>
    public abstract class PathGeneratorBase : IPathGenerator
    {
        ...
        private string GetFileName(string fileName)
        {
            ...
            return $"{name}-{TimeHelper.GetDateTime():HHmmss}.{extension}";
        }
        ...
        {
            fileName = RegexHelper.Replace(fileName, "\\W", "");
            return StringHelper.PinYin(fileName);
        }
    }
}
