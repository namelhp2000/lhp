...
namespace RoadFlow.Utility
{
    ...
    public static class ReflectionHelper
    {
        ...
        {
            return GetDescription(StringExtensions.GetType<T>());
        }
        ...
        {
            return GetDescription(StringExtensions.GetType<T>(), memberName);
        }
        ...
        {
            return GetDisplayName(StringExtensions.GetType<T>());
        }
        ...
        {
            return GetDisplayNameOrDescription(StringExtensions.GetType<T>());
        }
