...
namespace RoadFlow.Utility
{
    ...
    public static class EnumHelper
    {
        ...
        public static TEnum Parse<TEnum>(object member)
        {
            ...
            return (TEnum)System.Enum.Parse(StringExtensions.GetType<TEnum>(), value, true);
        }
        ...
        {
            return GetName(StringExtensions.GetType<TEnum>(), member);
        }
        ...
        {
            return GetValue(StringExtensions.GetType<TEnum>(), member);
        }
        ...
        {
            type = StringExtensions.GetType(type);
