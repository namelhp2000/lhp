...
#endif
using RoadFlow.Utility.Security.Principals;
...
namespace RoadFlow.Utility
{
    ...
    public static class WebHelper
    {
...
#if NETCOREAPP3_0
                Environment = IocHelper.Create<IWebHostEnvironment>();
#else
        ...
        /// Web客户端，用于发送Http请求
        /// </summary>
        public static RoadFlow.Utility.Webs.Clients.WebClient Client()
        {
            return new RoadFlow.Utility.Webs.Clients.WebClient();
        }
        ...
        public static RoadFlow.Utility.Webs.Clients.WebClient<TResult> Client<TResult>() where TResult : class
        {
            return new RoadFlow.Utility.Webs.Clients.WebClient<TResult>();
        }
