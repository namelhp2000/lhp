...
namespace RoadFlow.Utility.Helper.Internal
{
    /// <summary>
    ...
    internal class RsaHelper
    {
        ...
        public string EncryptRsa(string data)
        {
            ...
            var signatureBytes = _publicKeyRsaProvider.Encrypt(dataBytes, RSAEncryptionPadding.Pkcs1);
        ...
        public string DecryptRsa(string data)
        {
            ...
            var signatureBytes = _privateKeyRsaProvider.Decrypt(dataBytes, RSAEncryptionPadding.Pkcs1);

            return _encoding.GetString(signatureBytes);
        }
