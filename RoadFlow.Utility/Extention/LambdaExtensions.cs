using RoadFlow.Utility.Datas.Queries;
using RoadFlow.Utility.Expressions;
using System;
using System.Linq;
...
namespace RoadFlow.Utility
{
    ...
    public static class LambdaExtensions
    {
        ...
        {
            return left.Equal(LambdaHelper.Constant(value, left));
        }
        ...
        {
            return left.NotEqual(LambdaHelper.Constant(value, left));
        }
        ...
        {
            return left.Greater(LambdaHelper.Constant(value, left));
        }
        ...
        {
            return left.GreaterEqual(LambdaHelper.Constant(value, left));
        }
        ...
        {
            return left.Less(LambdaHelper.Constant(value, left));
        }
        ...
        {
            return left.LessEqual(LambdaHelper.Constant(value, left));
        }
