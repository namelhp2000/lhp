...
namespace RoadFlow.Utility.Randoms
{
    /// <summary>
    /// 随机数生成器
    /// </summary>
    public class RandomBuilder : IRandomBuilder
    {
        ...
        public string GenerateString(int maxLength, string text = null, bool fixedbool = false)
        {
            if (text == null)
        ...
        /// </summary>
        /// <param name="maxLength">最大长度</param>
        public string GenerateLetters(int maxLength, bool fixedbool = false)
        {
            return GenerateString(maxLength, ConstHelper.Letters, fixedbool);
        }
        ...
        /// </summary>
        /// <param name="maxLength">最大长度</param>
        public string GenerateChinese(int maxLength, bool fixedbool = false)
        {
            return GenerateString(maxLength, ConstHelper.SimplifiedChinese, fixedbool);
        }
        ...
        /// </summary>
        /// <param name="maxLength">最大长度</param>
        public string GenerateNumbers(int maxLength, bool fixedbool = false)
        {
            return GenerateString(maxLength, ConstHelper.Numbers, fixedbool);
        }
