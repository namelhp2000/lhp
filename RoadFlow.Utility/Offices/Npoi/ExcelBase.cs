...
using NPOI.SS.Util;
using RoadFlow.Utility.Offices.Abstractions;
        ...
        private void SetCellValue(object value)
        {
            ...
            switch (value.GetType().ToString())
            {
                ...
                case "System.DateTime":
                    _cell.SetCellValue(ConvertHelper.ToDate(value));
                    _cell.CellStyle = CreateDateStyle();
                    break;
                case "System.Boolean":
                    _cell.SetCellValue(ConvertHelper.ToBool(value));
                    break;
                case "System.Byte":
                case "System.Int16":
                case "System.Int32":
                case "System.Int64":
                    _cell.SetCellValue(ConvertHelper.ToInt(value));
                    break;
                case "System.Double":
                case "System.Decimal":
                    _cell.SetCellValue(ConvertHelper.ToDouble(value));
                    break;
                default:
                    _cell.SetCellValue("");
                    break;
