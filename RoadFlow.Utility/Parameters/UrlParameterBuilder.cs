using RoadFlow.Utility.Parameters.Formats;
using System;
using System.Collections.Generic;
using System.Web;

namespace RoadFlow.Utility.Parameters
{
    /// <summary>
    /// Url参数生成器
    /// </summary>
    public class UrlParameterBuilder
    {
        ...
        {
            var form = WebHelper.Request?.Form;
            if (form == null)
                return;
        ...
        {
            var query = WebHelper.Request?.Query;
            if (query == null)
                return;
        ...
        {
            return Url1Helper.Join(url, Result());
        }
