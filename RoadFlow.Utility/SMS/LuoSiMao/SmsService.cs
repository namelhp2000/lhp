...
namespace RoadFlow.Utility.SMS.LuoSiMao
{
    /// <summary>
    /// 短信服务
    /// </summary>
    public class SmsService : ISmsService
    {
        ...
        {
            var result = await WebHelper.Client().Post("https://sms-api.luosimao.com/v1/send.json")
        ...
        {
            var result = JsonHelper.ToObject<LuoSiMaoResult>(message);
