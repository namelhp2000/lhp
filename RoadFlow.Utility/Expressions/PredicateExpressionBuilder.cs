...
namespace RoadFlow.Utility.Expressions
{
    /// <summary>
    /// 谓词表达式生成器
    /// </summary>
    public class PredicateExpressionBuilder<TEntity>
    {
        ...
        {
            _parameter = LambdaHelper.CreateParameter<TEntity>();
        }
        ...
        {
            _result = _result.And(_parameter.Property(LambdaHelper.GetMember(property)).Operation(@operator, value));
        }
