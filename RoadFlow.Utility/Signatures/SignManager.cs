using RoadFlow.Utility.Parameters;


namespace RoadFlow.Utility.Signatures
{
    /// <summary>
    /// 签名服务
    /// </summary>
    public class SignManager : ISignManager
    {
        ...
        public string Sign()
        {
            return EncryptHelper.Rsa2Sign(_builder.Result(true), _key.GetKey());
        }
        ...
        {
            return EncryptHelper.Rsa2Verify(_builder.Result(true), _key.GetPublicKey(), sign);
        }
    }
}
