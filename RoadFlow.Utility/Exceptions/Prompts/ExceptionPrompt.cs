...
namespace RoadFlow.Utility.Exceptions.Prompts
{
    /// <summary>
    /// 异常提示
    /// </summary>
    public static class ExceptionPrompt
    {
        ...
        public static string GetPrompt(Exception exception)
        {
            if (exception == null)
                return null;
            exception = ExtensionsExtention.GetRawException(exception);
...
#if NETCOREAPP3_0
            if (WebHelper.Environment.IsDevelopment() || IsShowSystemException)
