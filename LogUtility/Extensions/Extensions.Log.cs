...
namespace LogUtility.Extensions {
    ...
    public static partial class Extensions {
        ...
        public static ILog SqlParams( this ILog log, IEnumerable<KeyValuePair<string, object>> list ) {
            ...
            return SqlParams( log, RoadFlow.Utility.StringExtensions.RemoveEnd(  result.ToString(), $",{StringExtensions.Line}" ) );
        }
