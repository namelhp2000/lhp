...
namespace RoadFlow.Model
{
    ...
    [Serializable, Table("RF_MailInBox")]
    public class MailInBox
    {
        ...
        [Required(ErrorMessage = "接收人不能为空"), Column("UserId"), DisplayName("接收人")]
        public Guid UserId { get; set; }

        [Required(ErrorMessage = "发送人不能为空"), Column("SendUserId"), DisplayName("发送人")]
        ...
        [Required(ErrorMessage = "邮件类型不能为空"), Column("MailType"), DisplayName("邮件类型")]
