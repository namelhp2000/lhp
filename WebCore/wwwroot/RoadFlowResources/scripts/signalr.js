...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function __importDefault(mod) {
        return (mod && mod.__esModule) ? mod : { default1: mod };
    }


    var tslib_1 = undefined;
    try {
        tslib_1 = Object.freeze({
            __extends: __extends,
            __assign: __assign,
            __rest: __rest,
            ...
            */
            ...
            var Promise$2 = function () {
                ...
                */
                ...
                Promise.prototype._catch = function _catch(onRejection) {
                ...
                */
                ...
                Promise.prototype._finally = function _finally(callback) {
                    var promise = this;
    ...
    var HttpClient_1 = createCommonjsModule(function (module, exports) {
        ...
        var HttpClient = /** @class */ (function () {
            ...
            HttpClient.prototype._delete = function (url, options) {
        ...
        var SubjectSubscription = /** @class */ (function () {
            ...
            SubjectSubscription.prototype.dispose = function () {
                ...
                if (this.subject.observers.length === 0) {
                    this.subject.cancelCallback()._catch(function (_) { });
                }
            };
    ...
    var HubConnection_1 = createCommonjsModule(function (module, exports) {
        ...
        var HubConnection = /** @class */ (function () {
            ...
            HubConnection.prototype.stream = function (methodName) {
                ...
                this.connection.send(message)._catch(function (e) {
                    subject.error(e);
                    delete _this.callbacks[invocationDescriptor.invocationId];
                });
                return subject;
                        ...
                        return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, this.httpClient._delete(this.url, deleteOptions)];
                                case 2:
                                    response = _a.sent();
    ...
    var browserIndex = createCommonjsModule(function (module, exports) {
        ...
        try {
            if (Uint8Array && !Uint8Array.prototype.indexOf) {
            ...
            if (Uint8Array && !Uint8Array.prototype.forEach) {
