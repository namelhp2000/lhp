        ...
        CKEDITOR.dialog.add(pluginName, function (editor) {
            return {
                        ...
                        [
                            {
                                id: pluginName + '_attr',
                                type: 'html',
                                html: '<iframe style="width:100%;height:380px;border:0;" frameborder="0" src="../FormDesignerPlugin/Radio?' + query + '"></iframe>'
                            }
                        ]
                }, {
                ...
                onShow: function () {
                    ...
                    function initAttr() {
                        ...
                        if (element) {
                            ...
                            $("#ds_dict_value_radio", doc).val(element.getAttribute("data-ds_dict_value"));
                            $("#ds_dict_valuefield_radio", doc).val(element.getAttribute("data-ds_dict_valuefield"));
                ...
                onOk: function () {
                    ...
                    input.setAttribute("data-ds_dict_value", $("#ds_dict_value_radio", doc).val() || "");
                    input.setAttribute("data-ds_dict_valuefield", $("#ds_dict_valuefield_radio", doc).val() || "id");
