using RoadFlow.Utility.Offices;
using RoadFlow.Utility.Offices.Npoi;
using System;
using System.Collections.Generic;
using System.Text;
using Xunit;

namespace UnitTestUtilty.Offices
{
    /// <summary>
    /// Npoi导出测试
    /// </summary>
    public class ExportTest
    {
        ...
        {
            _export.Body(_list)
                .Write(RoadFlow.Utility.Config.FilePath+"/Test");
        }
        ...
        public void Test_2()
        {
            _export.Head("测试报表")
                .Body(_list)
                .Write(RoadFlow.Utility.Config.FilePath + "/Test", "Test_2");
        }
        ...
        public void Test_3()
        {
            _export.Head("测试", "测试", "测试", "测试", "测试", "测试", "测试", "测试", "测试", "测试", "测试", "测试", "测试", "测试", "测试", "测试")
                .Body(_list)
                .Write(RoadFlow.Utility.Config.FilePath + "/Test", "Test_3");
        }
        ...
        public void Test_4()
        {
            _export.Head("测试报表")
                ...
                .Body(_list)
                .Write(RoadFlow.Utility.Config.FilePath + "/Test", "Test_4");
        }
        ...
        public void Test_5()
        {
            _export.Head("测试报表")
                ...
                .Body(_list)
                .Write(RoadFlow.Utility.Config.FilePath + "/Test", "Test_5");
        }
        ...
        public void Test_6()
        {
            _export.Head("测试报表")
                ...
                .Write(RoadFlow.Utility.Config.FilePath + "/Test", "Test_6");
        }
        ...
        public void Test_7()
        {
            _export.Head("测试报表")
                ...
                .Write(RoadFlow.Utility.Config.FilePath + "/Test", "Test_7");
        }
        ...
        public void Test_8()
        {
            _export.Head("测试报表")
                ...
                .Write(RoadFlow.Utility.Config.FilePath + "/Test", "Test_8");
        }
        ...
        public void Test_9()
        {
            _export.Head("测试报表")
                ...
                .Foot("测试", "测试", "测试", "测试", "测试")
                .Write(RoadFlow.Utility.Config.FilePath + "/Test", "Test_9");
        }
    }
}
